...
public class PatnerAdapter extends BaseAdapter {
    ...
    public PatnerAdapter(Activity activity, ArrayList<PatnerEntity> patnerEntities) {
        this.activity = activity;
        layoutInflater = this.activity.getLayoutInflater();
        //this.patnerEntities = new DataBaseHelper(activity).getAllPatners();
    ...
    public View getView(final int position, View rootview, ViewGroup viewGroup) {
        ...
        viewHolder.item_firm_type.setText(new DataBaseHelper(activity).getFirmTypeByID(""+patnerEntities.get(position).getFirm_type()));
